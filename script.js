        ...
        if (formulario) {
            formulario.addEventListener('submit', (evento) => {
                ...
                fetch('datos.xml')
                    ...
                    .then(str => new window.DOMParser().parseFromString(str, "text/xml"))
                    .then(data => {
                        const usuariosXML = data.getElementsByTagName
                        ...
                        if (credencialesValidas) {
                            ...
                            alert('Error: Usuario o Clave de Seguridad incorrectos. Asegúrate de estar registrado en nuestro archivo XML.');
                        }
                    })
                    .catch(error => console.error('Error en la valudación XML:', error));
            });
        }
});